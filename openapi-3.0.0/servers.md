# OpenAPI 3.0.0 Conformance Table: Servers (ORM + REST API + Mocks + Tests)

This table tracks the completeness of language integration with OpenAPI 3.0.0 for server-side generation and extraction.
