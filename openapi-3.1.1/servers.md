# OpenAPI 3.1.1 Conformance Table: Servers (ORM + REST API + Mocks + Tests)

This table tracks the completeness of language integration with OpenAPI 3.1.1 for server-side generation and extraction.
