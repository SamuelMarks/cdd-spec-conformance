# OpenAPI 3.1.1 Conformance Table: Client SDK CLI (CLI Tooling & Tests)

This table tracks the completeness of language integration with OpenAPI 3.1.1 for generating Command-Line Interfaces (CLIs) wrapper tools, and vice-versa.
...
| OpenAPI 3.1.1 Object / Feature | Presence `[To, From]` | Absence `[To, From]` | Skipped `[To, From]` | Notes / Implementation Strategy |
| :--- | :---: | :---: | :---: | :--- |
